...
#################生成user1.bin文件#################
#COMPILE=gcc        描述：选用gcc编译器，此项不要改变
#BOOT=new           描述：boot文件方式：none：“eagle.flash.bin+eagle.irom0text.bin”模式;    old:“boot_v1.1”版本;   new：“boot_v1.2+”版本.
#APP=1              描述：主体bin文件方式：0：生成“eagle.flash.bin+eagle.irom0text.bin”文件;    1：生成“user1.bin”文件;    2：生成“user2.bin”文件.
#SPI_SPEED=40       描述：SPI速度（默认40MHz）：20MHz;    26.7MHz;    40MHz;    80MHz.
#SPI_MODE=QIO       描述：SPI模式（默认QIO）：QIO;    QOUT;    DIO;    DOUT.
#SPI_SIZE_MAP=2     描述：Flash容量：0= 512KB( 256KB+ 256KB);    2=1024KB( 512KB+ 512KB);    3=2048KB( 512KB+ 512KB);    4=4096KB( 512KB+ 512KB);    5=2048KB(1024KB+1024KB);    6=4096KB(1024KB+1024KB).
################生成user1.bin文件#################
#COMPILE=gcc
#BOOT=new
#APP=1
